...
class Pagination(PageNumberPagination):
    ...
    next: self.get_next_link() Returns the link(URL) to the next page. If there is no next page, None is returned.
    previous: self.get_previous_link() Returns the link(URL) from the previous page. If there is no previous page, None is returned.
